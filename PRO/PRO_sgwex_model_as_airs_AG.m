...
modeldirec = '/home/f/nh351/scratch/data/sgwex/3DST/Model/JustT/';

% and for saving...
savedirec = '/home/f/nh351/scratch/data/sgwex/3DST/Model_as_AIRS/AG_sm/';
...
% for d = 56
    ...
    Slurm.Name = [yyyymmdd '_Model_as_AIRS_AG'];
%     Slurm.Batch = 'batch-short';
    ...
    Slurm.Command = [Slurm.Command ...
        'yyyymmdd = ''' yyyymmdd '''; ' ...
        'airsdirec = ''' airsdirec '''; ' ...
        'modeldirec = ''' modeldirec '''; ' ...
        'savedirec = ''' savedirec '''; ' ...
        'FUN_sgwex_model_as_airs_regrid_and_3dst_AG(yyyymmdd,airsdirec,modeldirec,savedirec)'];
